...
if (!empty($_SESSION['userId'])){
    echo '<a type="button" class="btn btn-primary me-2" href="/sae202/app-sae202/board.php">Accueil</a>';
    echo '<button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">Bienvenue '. $_SESSION['userPrenom'].'</button><br>';
}
